...
const SCALE_ADAPTIVE_FG = 0.5;    // Capacitor adaptive foreground (transparent) — sized for the 66dp safe zone inside the 108dp canvas; bumping this up makes the home-screen icon look oversized on most launchers
